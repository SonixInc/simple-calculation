# Запуск проекта
1. Инициализировать проект командой `make init`
2. Выполнить миграции `make run-migrations`
3. Запустить фикстуры `make fixtures`

# Тестирование
1. Скопировать id продукта в `requests.http`
2. Запустить запрос
